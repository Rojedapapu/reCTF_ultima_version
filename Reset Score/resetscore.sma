...
public reset_score(id)
{
	...
	if(get_pcvar_num(pcvar_Display) == 1)
	{
		...
		client_print(0, print_chat, "%s reset your score", name)
	}
	else
	{
		client_print(id, print_chat, "Make your score reset!")
	}
}
...
public advertise()
{
	...
	show_hudmessage(0, "say /rs to reset your score.")
}
...
public connectmessage(id)
{
	...
	{
	client_print(id, print_chat, "say /rs to reset your score")
	}
}
