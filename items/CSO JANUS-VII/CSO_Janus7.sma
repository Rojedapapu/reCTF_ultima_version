...
#define DAMAGE_A 65 // Damage in Non-Charged Mode
#define DAMAGE_B 60 // Damage in Charged Mode
...
public plugin_init()
{
	...
	register_clcmd("Get_Janus7", "Get_Janus77")
	register_clcmd("weapon_m249", "Hook_Weapon")

	g_item = ctf_item("Janus 7", 100, 90, ADMIN_ALL, "");	
}
public Get_Janus77(id) {
	if (is_user_admin(id)) {
		Get_Janus7(id)
	}
}
