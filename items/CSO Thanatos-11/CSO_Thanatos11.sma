...
#define DAMAGE_A 160 // 140 for zombie, 70 for human
#define DAMAGE_B 100 // 560 for zombie, 280 for human
...
public plugin_init()
{
	...
	register_clcmd("Get_Thanatos11", "Get_Thanatos11")
	g_item = ctf_item( "Thanatos-11", 100, 50, ADMIN_ALL, "" );
	// Attach
